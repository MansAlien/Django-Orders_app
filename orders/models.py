...
class Payment(models.Model):
    ...
    order = models.ForeignKey(Order, on_delete=models.PROTECT)
    discount = models.DecimalField(decimal_places=2, max_digits=4, null=True, default=0.00)
    total = models.DecimalField(decimal_places=2, max_digits=10, null=True, blank=True)
    paid = models.DecimalField(decimal_places=2, max_digits=10, null=True, default=0.00)
    payment_method = models.CharField(max_length=1, choices=[(k, v) for k, v in PAYMENT_METHOD.items()], default="C")
